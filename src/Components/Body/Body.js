...
const Body = () => {
  const initialState = [];
  const [nasaData, setNasaData] = useState(initialState);
  ...
  //   hdurl:
  //     "https://apod.nasa.gov/apod/image/2002/SouthernMoonscapeClaviusTycho.jpg",
  //   media_type: "image",
  //   service_version: "v1",
  ...
  return (
  <div>
    <div><BodyHeader title={nasaData}/></div>
    ...
    <div><BodyAbout about={nasaData}/></div>
  </div>
  );
}
